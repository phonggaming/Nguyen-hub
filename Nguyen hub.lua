...
local nguyenNotify = function(Text_i,Duration_i)
    game.StarterGui:SetCore("SendNotification", {
        Title = "Nguyên 6a hub",
        Text = Text_i,
        Duration = Duration_i,
        Icon = "rbxassetid://83537697952982"
    })
end
--Key
wait(0.1)
nguyenNotify("Thanks for using nguyên hub!",5)
wait(0.1)
nguyenNotify("discord.gg/dUdzZskBCC",5)
wait(0.5)
local Notification = require(game:GetService("ReplicatedStorage").Notification)
Notification.new("<Color=Cyan>nguyen Hub V2Script<Color=/>"):Display()
wait(0.5)
...
HomePage:Seperator("nguyen Hub")

HomePage:Label("Blox Fruits | English Version")

HomePage:Seperator("Status")
local nguyenStatuOn_Time = HomePage:Label("")
local nguyenStatuOn_Player = HomePage:Label("Name : "..game.Players.LocalPlayer.Name)
local nguyenStatuOn_FPS = HomePage:Label("")
local nguyenStatuOn_Ping = HomePage:Label("")
function AUpdateInfo()
    ...
    nguyenStatuOn_Time:Set("Time : ".. hour .. " : " .. minute .. " : " .. second)
    nguyenStatuOn_FPS:Set("FPS : "..fps)
    nguyenStatuOn_Ping:Set("Ping : "..Ping)
end
task.spawn(function()
    while task.wait() do
        AUpdateInfo()
...
HomePage:Button("Copy Discord Link", function()
    nguyenNotify("Copy Discord Link!",5)
